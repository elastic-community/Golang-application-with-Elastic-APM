...
Original blog link :- https://medium.com/@sadhamhussian2020/application-monitoring-in-golang-application-with-elastic-apm-220899261e46
...
func main() {
	db, err := apmgorm.Open("mysql", fmt.Sprintf("%s:%s@(%s:%s)/%s?charset=utf8&parseTime=True&loc=Local&charset=utf8mb4&collation=utf8mb4_unicode_ci",
		"root",
		"root",
		"localhost",
		"3306",
...
[Sadham Hussian M](https://github.com/Sadham-Hussian)
